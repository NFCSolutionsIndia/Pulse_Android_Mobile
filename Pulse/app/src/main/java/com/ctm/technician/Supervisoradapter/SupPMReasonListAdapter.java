...
public class SupPMReasonListAdapter extends RecyclerView.Adapter<SupPMReasonListAdapter.MyViewHolder> {

    private List<TicketHistoryList> getstaffMembersLists;
    private CommonFunctions com;
    private CommonSharePrefrences comShare;
    private SupPlannedeventchecklistAssetsActivity context;
    int ticketid, typeid, siteid;
    String sitename, tcstatus;
    private onItemClick click;
    TicketHistoryList response;

    public SupPMReasonListAdapter(List<TicketHistoryList> staffMembersLists, onItemClick click, String tcstatus, int siteid, String sitename, CommonSharePrefrences comShare, int ticketid, int typeid, SupPlannedeventchecklistAssetsActivity context) {
    ...
    @Override
    public SupPMReasonListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.view_servicessup, parent, false);
        return new SupPMReasonListAdapter.MyViewHolder(itemView);
    }
