...
public class ChecklistAssetsListAdapter extends RecyclerView.Adapter<ChecklistAssetsListAdapter.MyViewHolder> {

    private List<PMAssetdata> getstaffMembersLists;
    private CommonFunctions com;
    private CommonSharePrefrences comShare;
    private ChecklistAssetsActivity context;
    int ticketid, typeid, siteid;
    String sitename, tcstatus,distance,site_uniqueid;
    private onItemClick click;

    public ChecklistAssetsListAdapter(List<PMAssetdata> staffMembersLists, onItemClick click, String tcstatus, int siteid, String sitename,String site_uniqueid, CommonSharePrefrences comShare, int ticketid, int typeid,String distance, ChecklistAssetsActivity context) {
    ...
    @Override
    public ChecklistAssetsListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.assert_checllist, parent, false);
        return new ChecklistAssetsListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(ChecklistAssetsListAdapter.MyViewHolder holder, int position) {
        ...
        if (response.getAssetCheckListStatus() == 1) {
            ...
            holder.cardview.setBackgroundResource(R.drawable.roundedgradiantline);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView assetimg,checked,edit;
        ...
        public MyViewHolder(View view) {
            ...
            cardview.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                        ...
                        Log.e("datatataaa",  "" + getstaffMembersLists.get(getLayoutPosition()).getDistance());
