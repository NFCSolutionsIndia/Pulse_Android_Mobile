...
public class ClosedAdapter extends RecyclerView.Adapter<ClosedAdapter.MyViewHolder> {
    Context context;
    ...
    public ClosedAdapter(Context activity, List<PMTicketData> listOfOrdersWithServices, CommonSharePrefrences comShare) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if (jobsList.get(position).getPmTicketStatusName().contains("Closed")) {
