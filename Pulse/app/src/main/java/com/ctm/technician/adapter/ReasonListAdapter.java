...
public class ReasonListAdapter extends RecyclerView.Adapter<ReasonListAdapter.MyViewHolder> {
    ...
    public ReasonListAdapter(List<TicketHistoryList> staffMembersLists, onItemClick click, String tcstatus, int siteid, String sitename, CommonSharePrefrences comShare, int ticketid, int typeid, ChecklistAssetsActivity context) {
    ...
    public ReasonListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ReasonListAdapter.MyViewHolder(itemView);
    }
