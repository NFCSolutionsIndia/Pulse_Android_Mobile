...
public class SupNavigationDrawerAdapter extends BaseAdapter {
    private Context context;
    private String[] drawerItems;
    private String[] drawerImages;
    private CommonFunctions com;
    private CommonSharePrefrences comShare;
    public SupNavigationDrawerAdapter(Context context){
        ...
        Resources resources = context.getResources();
            ...
            drawerItems = resources.getStringArray(R.array.supdrawerItems);
            drawerImages = resources.getStringArray(R.array.supdrawerImages);
