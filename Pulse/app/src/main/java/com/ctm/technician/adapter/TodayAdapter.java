...
public class TodayAdapter extends RecyclerView.Adapter<TodayAdapter.MyViewHolder> {
    ...
    String techname, techmobile;
    int techid;
    private ArrayList<PMTicketData> filterList;
    int lastItemPosition = -1;

    public TodayAdapter(Context activity, String techname, int technicianid, String mobile, List<PMTicketData> listOfOrdersWithServices, CommonSharePrefrences comShare) {
        this.context = activity;
        this.comShare = comShare;
        this.techname = techname;
        this.techid = technicianid;
        this.techmobile = mobile;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if (!comShare.getdesignation().equals("Technician")) {
            if (jobsList.get(position).getPmTicketStatusName().equals("Open")) {
                holder.ticketstatus.setTextColor(context.getResources().getColor(R.color.opentextcolor));
            }
            if (jobsList.get(position).getPmTicketStatusName().equals("Reassign")) {
                holder.ticketstatus.setTextColor(context.getResources().getColor(R.color.opentextcolor));
            }
            if (jobsList.get(position).getPmTicketStatusName().equals("Pending")) {
                holder.ticketstatus.setTextColor(context.getResources().getColor(R.color.pendingtextcolor));
            }
            if (jobsList.get(position).getPmTicketStatusName().equals("Closed")) {
                holder.ticketstatus.setTextColor(context.getResources().getColor(R.color.closedtextcolor));
            }
            if (jobsList.get(position).getPmTicketStatusName().equals("Overdue")) {
                holder.ticketstatus.setTextColor(context.getResources().getColor(R.color.overduetextcolor));
            }
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView petext, tickettype, tech_name, tech_contact, input_id, labelsitename, description, title, input_sitename, input_site_id, recCreateDate, ticketstatus, labeiid;
        ...
        public MyViewHolder(View view) {
            ...
            petext = (TextView) view.findViewById(R.id.petext);
            ...
            if (comShare.getdesignation().equals("Technician")) {
                ...
                tech_name.setText(techname);
                tech_contact.setText(techmobile);
                ...
                public void onClick(View view) {
                    ...
                    if (jobsList.get(getLayoutPosition()).getTicketType().equals("PM")) {
                        ...
                        if (comShare.getdesignation().equals("Technician")) {
                            ...
                            intent.putExtra("pmplandate", String.valueOf(jobsList.get(getLayoutPosition()).getDateAsPerPMPlan()));
                            intent.putExtra("status", String.valueOf(jobsList.get(getLayoutPosition()).getPmTicketStatusName()));
                            intent.putExtra("tech_name", techname);
                            intent.putExtra("site_uniqueid", String.valueOf(jobsList.get(getLayoutPosition()).getSiteUniqueId()));

                            intent.putExtra("tech_contact", techmobile);
                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            context.startActivity(intent);
                        }
                    } else {
